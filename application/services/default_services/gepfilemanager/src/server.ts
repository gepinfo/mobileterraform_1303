...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_mobileterraform_1303;
            let db_auth = result.data.DB_AUTH_mobileterraform_1303;
            let db_coll = result.data.DB_COLL_mobileterraform_1303;
